...
def write_api():
    ...
    for i in package_json['data']:
        ...
        cursor.execute("""INSERT INTO tbl_students_0515
...
def show_data():
    cursor = con.cursor()
    cursor.execute('SELECT * FROM tbl_students_0515')
...
def show_data_nim():
    ...
    cursor = con.cursor()
    cursor.execute('SELECT * FROM tbl_students_0515 WHERE nim = ' + x + nim + x)
